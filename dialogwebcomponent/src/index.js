...
import dialogPolyfillCss from 'dialog-polyfill/dialog-polyfill.css'
import myHTMLDialogTemplateString from './mydialog.html'

const helperElement = document.createElement('div');
helperElement.innerHTML = myHTMLDialogTemplateString
    .trim()
    .replace('__dialogPolyfillCss__', dialogPolyfillCss);
